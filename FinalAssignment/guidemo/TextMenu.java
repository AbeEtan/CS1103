...
public class TextMenu extends JMenu {
	...
	private JRadioButtonMenuItem justify;
	...
	public TextMenu(DrawPanel owner) {
		...
		/**
		 * Step 6: Use an Input Dialog to set line spacing
		 */
	...
	/**
	 *Step 5: Add Radio Buttons in a Submenu to justify text
	 * @return
	 */

	private JMenu makeJustifySubMenu() {
		JMenu menu = new JMenu("Justify");
		ActionListener setJustifyTextAction = new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
		...
		leftMenuItem.addActionListener(setJustifyTextAction);
		...
		centerMenuItem.addActionListener(setJustifyTextAction);

		JRadioButtonMenuItem rightMenuItem = new JRadioButtonMenuItem("Right");
		rightMenuItem.addActionListener(setJustifyTextAction);
