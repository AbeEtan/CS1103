...
public class IconSupport {
	...
	/** Step 1: Make a Menu
	 * this method returns a menu with the same functionality as the toolbar.
	 * Enable user to select a stamp icon from a menu list to drop on the image
	 * This method adds a separator line after each item on the menu
	 */
	
	public JMenu createMenu() {
		JMenu stamper = new JMenu("Item Stamper");
		for (int i = 0; i < actions.size() - 1; i++) {
